            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add New Frame</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.frames.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category"
                                    ...
                                    <option value="birthday" {{ old('category') == 'birthday' ? 'selected' : '' }}>Birthday
                                    </option>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">Create Frame</button>
                            </div>
                        </form>
                    </div>
                </div>
